    ...
    if(checkUserFullNameValid == null){
        ...
        firebase.auth().createUserWithEmailAndPassword(userEmail, userPassword).then((success) => {
            ...
            var userData = {
                ...
                userFb: "https://www.instagram.com/",
                userTw: "https://linkedin.com/",
                userGp: "https://github.com/",
                userBio: "User Biography",
                userRank: "Page not yet Created!!"
            }
            firebaseRef.child(uid).set(userData);
            swal('Your Account Created','Your account was created successfully!!',
            ).then((value) => {
                setTimeout(function(){
...
firebase.auth().onAuthStateChanged((user)=>{
    ...
    //   User is signed in.
        ...
        firebaseRefKey.on('value', (dataSnapShot)=>{
            ...
            document.getElementById("userPfPassword").innerHTML  = dataSnapShot.val().userPassword;
            ...
            document.getElementById("userPfRank").innerHTML = dataSnapShot.val().userRank;
            tempRank = dataSnapShot.val().userRank;
...
function showEditProfileForm(){
    ...
    var userPfRank = document.getElementById("userPfRank").innerHTML;
    var userPfPassword = document.getElementById("userPfPassword").innerHTML;
    ...
    document.getElementById("userRank").value = userPfRank; 
    document.getElementById("userPassword").value = userPfPassword; 
...
function saveProfile(){
    ...
    let userRank = document.getElementById("userRank").value
...
function signOut(){
 ...
 document.getElementById("confRank").style.display = "none";
 document.getElementById("confPass").style.display = "none";
 document.getElementById("confMail").style.display = "none";
 document.getElementById("confPass2").style.display = "none";
